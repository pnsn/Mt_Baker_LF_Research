...
Logger.info(f'Filtered event bank contents from {len(df_evid)} to {len(df_wlevid)} well-located EVIDS ')

for evid, row in df_wlevid.iterrows():
    # Announce iteration
    Logger.warning(f'...running {evid}')
