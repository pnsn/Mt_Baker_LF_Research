...
def add_rings(geoaxis, rads_km=[10, 30, 50, 70, 90], rads_colors=['black','firebrick','darkgreen','darkblue','purple'], npts=101, label_pt=28):
    for _e, _r in enumerate(rads_km):
        ...
        # Label Radii
        geoaxis.text(mE[label_pt], mN[label_pt]+1e3, f'{_r:d} km', va='bottom', ha='center', transform=UTM10N)
